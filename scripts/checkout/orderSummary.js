...
export function renderOrderSummary() {
  ...
  function deliveryOptionsHTML(matchingProduct, cartItem) {
    ...
    deliveryOptions.forEach((deliveryOption) => {
      // const today = dayjs();
      // const deliveryDate = today.add(deliveryOption.deliveryDays, "days");
      const dateString = calculateDeliveryDate(deliveryOption); //deliveryDate.format("dddd, MMMM D");
      const priceString =
      ...
      html += `
          <div class="delivery-option js-delivery-option js-delivery-product-id-${
            matchingProduct.id
        ...
        deliveryOption.id
            ...
            <input type="radio"
              ${isChecked ? "checked" : ""}
              class="delivery-option-input js-delivery-input-product-id-${
            matchingProduct.id
          }-delivery-option-id-${deliveryOption.id}"
